...
onMounted(() => {
    form.supplier_id = props.purchaseOrder.supplier_id;
    form.order_date = new Date(props.purchaseOrder.order_date);
...
const submit = () => {
    form.post(route("purchase-orders.update", props.purchaseOrder.id));
};
</script>
